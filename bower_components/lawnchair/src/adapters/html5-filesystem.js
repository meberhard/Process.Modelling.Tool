    ...
    return {
        ...
        init: function( options, callback ) {
            ...
            requestFileSystem( (options.storage === 'TEMPORARY' ? TEMPORARY : PERSISTENT), (options.size || 1024*1024*1024), function( fs ) {
                fs.root.getDirectory( options.name, {createStore:true}, function( directory ) {
        ...
        save: function( obj, callback ) {
            ...
            root( this, function( store ) {
                store.getFile( key, {createStore:true}, function( file ) {
        ...
        get: function( key /* or array */, callback ) {
            ...
            if ( this.isArray( key ) ) {
                ...
                var error = function(e) { fail( e ); if ( callback ) me.lambda( callback ).call( me ); };
                root( this, function( store ) {
                    store.getFile( key, {createStore:false}, function( entry ) {
        ...
        exists: function( key, callback ) {
            var me = this;
            root( this, function( store ) {
                store.getFile( key, {createStore:false}, function() {
        ...
        remove: function( key /* or object */, callback ) {
            ...
            var error = function(e) { fail( e ); if ( callback ) me.lambda( callback ).call( me ); };
            root( this, function( store ) {
                store.getFile( (typeof key === 'string' ? key : key.key ), {createStore:false}, function( file ) {
